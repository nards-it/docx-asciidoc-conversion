...
image:media\image3.png[image,width=100,height=100, align=center] **INSPIRE** - *Infrastructure for Spatial Information in Europe*
...
====
[.text-center]
*TG Requirement 10* Break line spatial objects should be always provided using 2.5-D geometries, in order to properly describe the singularities of the surface being represented
====
...
!===
*A.2 Part 2 : Conformity with the technical guideline (TG) Requirements*
a|
!===
...
|Post condition a|
The DTM and/or DSM of both "dry" elevation and "wet" elevation can be merged into a seamless datasappet. With adequate models to open sea areas, the coastal zone height information can be included.
|===
