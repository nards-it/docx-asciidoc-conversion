...
image:media\image2.jpeg[image]

image:media\image3.wmf[image]
...
2.6 How the Technical Guidance maps to the Implementing Rules 10

2.6.1 Requirements 10

2.6.2 Recommendations 11

2.6.3 Conformance 11

3 Specification scopes 11

4 Identification information 11

5 Data content and structure 12

5.1 Application schemas – Overview 12

5.1.1 Application schemas included in the IRs 12

5.2 Basic notions 13
...
5.2.5 Consistency between spatial data sets 19

5.2.6 Identifier management 19

5.2.7 Geometry representation 20

5.2.8 Temporality representation 20

5.2.9 Coverages 21

5.3 Application schema Elevation 23

5.3.1 Description 23

5.4 Application schema ElevationBaseTypes 31

5.4.1 Description 31

5.4.2 Feature catalogue 31

5.5 Application schema ElevationGridCoverage 33

5.5.1 Description 33

5.5.2 Feature catalogue 45

5.6 Application schema ElevationVectorElements 49

5.6.1 Description 49

5.6.2 Feature catalogue 52

5.6.3 Externally governed code lists 61

5.7 Application schema ElevationTIN 63

5.7.1 Description 63

5.7.2 Feature catalogue 66

6 Reference systems, units of measure and grids 69

6.1 Default reference systems, units of measure and grid 69

6.1.1 Coordinate reference systems 69

6.1.2 Temporal reference system 72

6.1.3 Units of measure 73

6.1.4 Grids 73

6.2 Theme-specific requirements and recommendations 74

6.2.1 Coordinate reference systems 74

6.2.2 Grids 81

7 Data quality 84

7.1 Data quality elements 84

7.1.1 Completeness – Commission 85

7.1.2 Completeness – Omission 86

7.1.3 Logical consistency – Conceptual consistency 86

7.1.4 Logical consistency – Domain consistency 87

7.1.5 Logical Consistency – Format consistency 87

7.1.6 Logical Consistency – Topological consistency 88

7.1.7 Positional accuracy – Absolute or external accuracy 91

7.1.8 Positional accuracy – Gridded data position accuracy 92

7.2 Minimum data quality requirements 93

7.3 Recommendation on data quality 94

8 Dataset-level metadata 95

8.1 Metadata elements defined in INSPIRE Metadata Regulation 95

8.1.1 Conformity 96

8.1.2 Lineage 99

8.1.3 Temporal reference 99

8.2 Metadata elements for interoperability 100

8.2.1 Coordinate Reference System 101

8.2.2 Temporal Reference System 101

8.2.3 Encoding 102

8.2.4 Character Encoding 103

8.2.5 Spatial representation type 103

8.2.6 Data Quality – Logical Consistency – Topological Consistency 104

8.3 Recommended theme-specific metadata elements 104

8.3.1 Maintenance Information 105

8.3.2 Metadata elements for reporting data quality 105

8.3.3 Spatial representation information 107

8.3.4 Supplemental information 107

8.3.5 Process step 108

8.3.6 Data source 109

8.3.7 Browse graphic information 110

8.3.8 Digital transfer options information 110

9 Delivery 111

9.1 Updates 111

9.2 Delivery medium 111

9.3 Options for delivering coverage data 112

9.4 Encodings 113

9.4.1 Default Encoding(s) 113

9.4.2 Recommended Encoding(s) 117

10 Data Capture 117

10.1 Elevation - Coverages (Grids) 117

10.1.1 Grid spacing 117

10.2 Elevation - Vector elements 118

10.2.1 Generic consistency rules 118

10.2.2 Density of Elevation data 118

10.3 Elevation - TIN 120

10.4 Bathymetry-specific objects 120

11 Portrayal 121

11.1 Layers to be provided by INSPIRE view services 122

11.1.1 Layers organisation 122

11.2 Styles required to be supported by INSPIRE view services 122

11.2.1 Styles for the layer EL.BreakLine 122

11.2.2 Styles for the layer EL.ContourLine 123

11.2.3 Styles for the layer EL.IsolatedArea 124

11.2.4 Styles for the layer EL.SpotElevation 125

11.2.5 Styles for the layer EL.VoidArea 127

11.2.6 Styles for the layer EL.GridCoverage 128

11.2.7 Styles for the layer EL.TIN 129

11.2.8 Examples 130

11.3 Styles recommended to be supported by INSPIRE view services 133

11.3.1 Styles for the layer EL.ContourLine 133

11.3.2 Examples 136

Bibliography 137

Annex A (normative) Abstract Test Suite 139

A.1 Application Schema Conformance Class 142

A.1.1 Schema element denomination test 142

A.1.2 Value type test 142

A.1.3 Value test 142

A.1.4 Attributes/associations completeness test 143

A.1.5 Abstract spatial object test 143

A.1.6 Constraints test 144

A.1.7 Geometry representation test 144

A.2 Reference Systems Conformance Class 144

A.2.1 Datum test 144

A.2.2 Coordinate reference system test 145

A.2.3 Vertical Coordinate Reference System exclusiveness test 145

A.2.4 Grid test 145

A.2.5 View service coordinate reference system test 146

A.2.6 Temporal reference system test 146

A.2.7 Units of measurements test 146

A.3 Data Consistency Conformance Class 146

A.3.1 Unique identifier persistency test 147

A.3.2 Version consistency test 147

A.3.3 Life cycle time sequence test 147

A.3.4 Update frequency test 147

A.3.5 Grid aggregation test 148

A.3.6 Contour line test 148

A.3.7 Break line test 148

A.3.8 Isolated area test 148

A.3.9 Stop line test 149

A.4 Metadata IR Conformance Class 149

A.4.1 Metadata for interoperability test 149

A.4.2 Metadata completeness test 149

A.5 Information Accessibility Conformance Class 150

A.5.1 Code list publication test 150

A.5.2 CRS publication test 150

A.5.3 CRS identification test 150

A.5.4 Grid identification test 150

A.6 Data Delivery Conformance Class 151

A.6.1 Encoding compliance test 151

A.6.2 Minimum data delivery test 151

A.7 Portrayal Conformance Class 151

A.7.1 Layer designation test 151

A.2 Part 2 : Conformity with the technical guideline (TG) Requirements 152

A.8.1 Multiplicity test 152

A.8.2 CRS http URI test 152

A.8.3 Metadata encoding schema validation test 152

A.8.4 Metadata occurrence test 152

A.8.5 Metadata consistency test 153

A.8.6 Encoding schema validation test 153

A.8.7 Coverage multipart representation test 153

A.8.8 Coverage domain consistency test 153

A.8.9 TIFF conformity test 154

A.8.10 TIFF data structure test 154

A.8.11 TIFF range coding test 154

A.8.12 TIFF range compression test 154

A.8.13 TIFF grid coordinate system test 155

A.8.14 Style test 155

Annex B (informative) Use-Cases 156

B.1 Documented high-level use cases 156

B.1.1 Flood mapping 156

B.1.2 Orthoimagery production 159

B.1.3 Elevation mapping 164

B.1.4 Maintenance of fairways 166

B.2 Additional applications 167

Annex C (normative) Code list values 168

Annex D (informative) Pan-European Geographic Grid for gridded Elevation data 170

D.1 Introduction 170

D.2 Zoned Geographic Grid for gridded Elevation data 171

Annex E (informative) Examples on how to use ChartDatum data type 177

E.1 Description of the sea floor 177

E.2 Description of the floor of an inland standing water body 178

E.3 Description of the bed of a navigable river 178

Annex E (normative) Encoding rules for TIFF 179

E.1 Introduction 179

E.2 TIFF format 179

E.2.1 Format overview 179

E.2.2 INSPIRE TIFF profile for grid coverage data 179

E.2.3 Mapping between TIFF and GML data structures 182
...
====
[.text-center]
*TG Requirement X* Spatial object types and data types shall comply with the multiplicities defined for the attributes and association roles in this section.
====
...
{empty}(1) If elevation data is updated based on new source data, the updated objects shall receive a new external object identifier.
...
image:media\image5.png[image] image:media\image6.png[image]
...
{empty}(2) The _domainExtent_ attribute of every _ElevationGridCoverage_ instance shall be at least populated with a subtype of _the EX_GeographicExtent_ type.

{empty}(3) The elevation property values included within the range set of a single _ElevationGridCoverage_ shall be referenced to one and only one vertical coordinate reference system.
...
{empty}(7) The ElevationGridCoverage package shall be restricted to two-dimensional geometries.
...
{empty}(8) Information about the acquisition dates of data contained in elevation grid coverages shall be provided at least in one of the following ways:

====

{empty}(a) by providing the metadata element Temporal reference for each spatial object through the _metadata_ attribute of the spatial object type _ElevationGridCoverage_.

{empty}(b) by providing the metadata element Temporal reference required by Regulation (EC) No 1205/2008 as a temporal extent.
...
*Association role: contributingElevationGridCoverage [the association has additional attributes - see association class ElevationGridCoverageAggregation]*
...
*Constraint: identicalOffsetVectorsWithinElevationCoverageAggregation*
...
*Constraint: rangeSetValuesAreOfTypeFloat*
...
[cols=",",options="header",]
|===
|*ElevationGridCoverageAggregation (association class)*
|
...
[arabic, start=10]
. Break line spatial objects should be always provided using 2.5-D geometries, in order to properly describe the singularities of the surface being represented.
...
|SpotElevationClassValue a|
Append the number in the "Classification Value" column of Table 4.9 to the URI prefix

_http://inspire.ec.europa.eu/codeList/SpotElevationClassValue/_
...
|closeness of reported coordinate values to values accepted as or being true |spatial object / spatial object type / dataset series / dataset a|
Horizontal
...
|Value domain non-conformance rate |0 % |Quality controls and data editing can be performed automatically
|7.1.5 a|
Logical consistency /
...
{empty}(1) If measures other than ISO data quality measures have been used to evaluate an elevation data set, the Lineage metadata element shall include information about those measures and, if possible, a reference to an online resource where more information is available.
...
<gco:CharacterString>D2.8.II.II Data Specification on Elevation –
...
[cols=",",options="header",]
|===
|*_Topographic map 1:10 000 (1:5 000)_* |
...
The contoue equidistance is also dependent on the vertical accuracy, taking into and the slope of terrain surface. When elevation interpolated from a contour map the vertical accuracy (RMSEv) should be not worse than indicated in** 
**Table 9 .
...
{empty}(3) The vector spatial objects provided as component of a TIN collection shall fiulfill the generic consistency rules provided for vector objects.
...
{empty}b) Reference: Art.12(1), Annex III 1.7.2 (7), and 1.7.3 of Commission Regulation No 1089/2010
...
{empty}a) Purpose: Verify whether one and only one vertical coordinate reference system has been used within a dataset delivered for INSPIRE

{empty}b) Reference: Annex III Section 1.7.2(3) and 1.7.4(1) of Commission Regulation 1089/2010

{empty}c) Test method: Check whether the values of the elevation property are expressed in the same vertical CRS in case of ElevationGridCoverage and ElevationTIN spatial representations.
...
{empty}a) Purpose: Verify that gridded data are available using the grid compatible with one of the coordinate reference systems defined in Commission Regulation No 1089/2010
...
{empty}a) Purpose: Verify whether all the updates in the source dataset(s) have been transmitted to the dataset(s) which can be retrieved for the <theme short name> using INSPIRE download services.
...
{empty}a) Purpose: Verify whether the contributing grid coverages are consistent when they are aggregated in one coverage.

{empty}b) Reference: Annex III Section 1.7.2(3) (4) and (5) of Commission Regulation 1089/2010.

{empty}c) Test Method: Verify whether the contributing coverage instances
...
{empty}a) Purpose: Verify whether contour lines follow the consistency rules specified in Commission Regulation 1089/2010.

{empty}b) Reference: Annex III Section 1.7.6(2) and 1.7.6(5) of Commission Regulation 1089/2010.

{empty}c) Test Method: Inspect elevationPropertyTypeValue referenced to the same vertical coordinate reference system for each pair of contour lines. The test is passed when
...
{empty}b) Reference: Annex III Section 1.7.6(3) and 1.7.6(4) of Commission Regulation 1089/2010.

{empty}c) Test Method: For each brake line that has an intersection point expressed as third coordinate (Z) in the same vertical coordinate reference system inspect the elevation value at the intersection point. The test is passed when the elevationPropertyTypeValue at this point is equal
...
{empty}a) Purpose: Verify whether an isolated area does not touch the external boundary of a void area.

{empty}b) Reference: Annex III Section 1.7.6(6) of Commission Regulation 1089/2010.

{empty}c) Test Method: Inspect each instance of IsolatedArea spatial object type. The test is passed when non of them touches the external boundary of VoidArea object type that contains it when they are referenced to the same vertical reference system.
...
{empty}a) Purpose: Verify whether triangles intersecting a stopline have been removed.

{empty}b) Reference: Annex III Section 1.7.4(2) of Commission Regulation 1089/2010.

{empty}c) Test Method: Inspect whether any of the stoplines present in the dataset intersect a triangle. The test is passed when the intersected triangles have been removed.
...
{empty}a) Purpose: Verify whether the metadata for interoperability of spatial data sets and services described in 1089/2010 Commission Regulation have been created..

{empty}b) Reference: Art.13 of Commission Regulation 1089/2010

{empty}c) Test Method: Inspect whether metadata describing the coordinate reference systems, temporal reference system, encoding, character encoding, spatial representation type and when applicable topological consistency have been created and published.

NOTE 1 Further technical information is given in section 8 of this document.

==== Metadata completeness test

{empty}a) Purpose: Verify whether the theme specific metadata required in 1089/2010 Commission Regulation have been created and published for each dataset related to the Elevation data theme.

{empty}b) Reference: Annex III Section 1.7.2(8) of Commission Regulation 1089/2010

{empty}c) Test Method: Inspect the existence of the following information in each dataset:
...
{empty}b) Reference: Art.6(3) and Annex III Section 1.5.4.1 and 1.5.4.3

{empty}c) Test Method: check whether the BrakeLineTypeValue and SpotElevationTypeValue code list are accessible in a register.
...
{empty}c) Test method: Check whether the identifier and the parameters of the CRS used for the dataset are included in a register.
...
{empty}a) Purpose: Verify whether each dataset delivered for INSPIRE has been made available according to the application schema specified in Commission Regulation 1089/2010.

{empty}b) Reference: Annex III Section 1.2 of Commission Regulation 1089/2010.

{empty}c) Test Method: Verify whether each elevation dataset delivered for INSPIRE follow at least the application schema:
...
{empty}b) Reference: Art. 14(1), Art14(2) and Annex III Section 1.8.
...
{empty}a) Purpose: Verification whether each instance of an attribute or association role specified in the application schema(s) does not include fewer or more occurrences than specified in section 5.
...
{empty}a) Purpose: Verify whether coverage data encoded in TIFF files comply with the TIFF 6.0 specification and receive the _image/tiff_ MIME type registered in RFC 3302.

{empty}b) Reference: TG Requirement 13 and 14

{empty}c) Test Method: Inspect whether coverage range encoded in TIFF files comply with Baseline TIFF extended to LZW compression.
...
{empty}a) Purpose: Verify whether coverage data encoded in TIFF files does not contain more than two image file directories (IFD) where the first contains the range set of the grid coverage, while the second the transparency mask, it any.

{empty}b) Reference: TG Requirement 15 and 16.

{empty}c) Test Method: Check the number and the designation of each TIFF files delivered for INSPIRE. The test is passed if the condition described in a) fulfils.

====  TIFF range coding test

{empty}a) Purpose: Verify the coding method used for the coverage range in TIFF files.

{empty}b) Reference: TG Requirement 18.

{empty}c) Test Method: Check whether the range values are expressed as signed or unsigned integers stored on 32 bits floating point.

====  TIFF range compression test

{empty}a) Purpose: Verify whether the compression method used for the coverage range in TIFF files follows the specification.

{empty}b) Reference: TG Requirement 21.

{empty}c) Test Method: Check the compression (if any) used to deliver TIFF files for INSPIRE. The test is passed when the file is:
...
{empty}a) Purpose: Verify whether the origin and the orientation of the grid coordinate system follows the specification.

{empty}b) Reference: TG Requirement 17.

{empty}c) Test Method: Check the origin and the orientation of the image coordinate system. The test is passed when:
...
[appendix]
== (informative) - Pan-European Geographic Grid for gridded _Elevation_ data
...
{empty}(1) When gridded data is delivered using geodetic coordinates the multi-resolution Zoned Geographic Grid defined in this annex may be used as a geo-referencing framework.
...
{empty}(3) The grid shall be based on the ETRS89-GRS80 geodetic coordinate reference system.
...
{empty}(4) The origin of the grid shall coincide with the intersection point of the Equator with the Greenwich Meridian (GRS80 latitude φ=0; GRS80 longitude λ=0).
...
{empty}(5) The grid orientation shall be south-north and west-east according to the net defined by the meridians and parallels of the GRS80 ellipsoid.
...
{empty}(2) The resolution levels are defined in Table 1.
...
{empty}(7) This grid shall be subdivided in zones. The south-north resolution of the grid shall have equal angular spacing. The west-east resolution of the grid shall be established as the product of angular spacing multiplied by the factor of the zone as defined in Table 1.
...
{empty}(8) The grid shall be designated Grid_ETRS89-GRS80z__n_res__, where _n_ represents the number of the zone and _res_ the cell size in angular units, as specified in Table 1.
====
...
[appendix]
== {blank}
*(informative) - Examples on how to use _ChartDatum_ data type*
