...
[cols=",",]
|===
|*Title* |D2.8.II/III.7 INSPIRE Data Specification on _Environmental Monitoring Facilities_ – Technical Guidelines
|*Creator* |INSPIRE Thematic Working Group _Environmental Monitoring Facilities_
|*Date* |2013-12-10
|*Subject* |INSPIRE Data Specification for the spatial data theme _Environmental Monitoring Facilities_
|*Publisher* |European Commission Joint Research Centre
|*Type* |Text
|*Description* |This document describes the INSPIRE Data Specification for the spatial data theme _Environmental Monitoring Facilities_
|*Contributor* |Members of the INSPIRE Thematic Working Group _Environmental Monitoring Facilities_
...
5.3 Application schema Environmental Monitoring Facilities 18

5.3.1 Description 18

5.3.2 Feature catalogue 29

5.3.3 Externally governed code lists 40

6 Reference systems, units of measure and grids 42

6.1 Default reference systems, units of measure and grid 42

6.1.1 Coordinate reference systems 42

6.1.2 Temporal reference system 45

6.1.3 Units of measure 45

6.1.4 Grids 46

6.2 Theme-specific requirements and recommendations 46

7 Data quality 47

7.1 Data quality elements 47

7.1.1 Logical consistency – Conceptual consistency 48

7.1.2 Logical consistency – Domain consistency 48

7.2 Minimum data quality requirements 49

7.3 Recommendation on data quality 49

8 Dataset-level metadata 49

8.1 Metadata elements defined in INSPIRE Metadata Regulation 49

8.1.1 Conformity 50

8.1.2 Lineage 52

8.1.3 Temporal reference 53

8.2 Metadata elements for interoperability 53

8.2.1 Coordinate Reference System 54

8.2.2 Temporal Reference System 55

8.2.3 Encoding 56

8.2.4 Character Encoding 57

8.2.5 Spatial representation type 57

8.2.6 Data Quality – Logical Consistency – Topological Consistency 57

8.3 Recommended theme-specific metadata elements 57

8.3.1 Maintenance Information 58

8.3.2 Metadata elements for reporting data quality 58
...
9.2 Delivery medium 61

9.3 Encodings 62

9.3.1 Default Encoding(s) 63

9.4 Options for delivering coverage data 64

10 Data Capture 65

11 Portrayal 65

11.1 Layers to be provided by INSPIRE view services 66

11.1.1 Layers organisation 66

11.2 Styles required to be supported by INSPIRE view services 67

11.2.1 Styles for the layer EF.EnvironmentalMonitoringFacilities 67

11.2.2 Styles for the layer EF.EnvironmentalMonitoringNetworks 69

11.2.3 Styles for the layer EF.EnvironmentalMonitoringProgrammes 71

11.3 Styles recommended to be supported by INSPIRE view services 72

Bibliography 73

Annex A (normative) Abstract Test Suite 75

A.1 Application Schema Conformance Class 78

A.1.1 Schema element denomination test 78

A.1.2 Value type test 78

A.1.3 Value test 78

A.1.4 Attributes/associations completeness test 79

A.1.5 Abstract spatial object test 79

A.1.6 Constraints test 79

A.1.7 Geometry representation test 80

A.2 Reference Systems Conformance Class 80

A.2.1 Datum test 80

A.2.2 Coordinate reference system test 80

A.2.3 Grid test 81

A.2.4 View service coordinate reference system test 81

A.2.5 Temporal reference system test 81

A.2.6 Units of measurements test 82

A.3 Data Consistency Conformance Class 82

A.3.1 Unique identifier persistency test 82

A.3.2 Version consistency test 82

A.3.3 Life cycle time sequence test 83

A.3.4 Validity time sequence test 83

A.3.5 Update frequency test 83

A.4 Data Quality Conformance Class 83

A.5 Metadata IR Conformance Class 84

A.5.1 Metadata for interoperability test 84

A.6 Information Accessibility Conformance Class 84

A.6.1 Code list publication test 84

A.6.2 CRS publication test 84

A.6.3 CRS identification test 85

A.6.4 Grid identification test 85

A.7 Data Delivery Conformance Class 85

A.7.1 Encoding compliance test 85

A.8 Portrayal Conformance Class 85

A.8.1 Layer designation test 85

A.9 Technical Guideline Conformance Class 87

A.9.1 Multiplicity test 87

A.9.1 CRS http URI test 87

A.9.2 Metadata encoding schema validation test 87

A.9.3 Metadata occurrence test 87

A.9.4 Metadata consistency test 88

A.9.5 Encoding schema validation test 88

A.9.6 Coverage multipart representation test 88

A.9.7 Coverage domain consistency test 88

A.9.8 Style test 89

Annex B (informative) Use cases 90

B.1 Use Cases Overview 90

B.2 1a. Identify Facilities and Networks available for a given area of interest and domain 90

B.3 1b. Access to background information behind the Monitoring Feature 92

B.4 2. Providing information on what an EF is actually monitoring 94

B.5 3a. Providing the observations and/or measurements acquired at a Fixed/Mobile EF level 96

B.6 3b. Providing the observations and/or measurements acquired when a sample is being made 97

B.7 4a. Reporting monitoring features 99

B.8 4b. Reporting monitoring features and Observations/Measurements 101

Annex C (normative) Code list values 103

Annex D (informative) Examples 106

D.1 Monitoring of water quantity in rivers 107

D.1.1 Domain introduction 107

D.1.2 Water quantity monitoring in the French Water Information System 107

D.1.3 Mapping to EF theme terminology 109

D.2 Landscape monitoring in Sweden 112

D.2.1 Domain introduction 112

D.2.2 Overall description of the monitoring programme NILS 112

D.2.3 Mapping to EF theme terminology 115

D.3 Air quality monitoring example 123

D.3.1.1 Domain introduction 123

D.3.1.2 Description of air quality monitoring in Austria 123

D.3.1.3 Mapping to EF theme terminology 126

D.4 Marine environment monitoring facilities 135

D.4.1 Domain introduction 135

D.4.2 Example at the Marine Institute 135

D.4.3 Mapping to EF theme terminology 139

D.5 How to extend EF data model when reused in a reporting context? 141

D.5.1 Domain introduction 141

D.5.2 European Air Quality Reporting Based on INSPIRE 141

D.5.3 Inspire specifications reuse methodology 142
...
+++Covered by EF data specification:+++
...
+++Not covered by EF data specification:+++
...
image:media\image5.png[image,width=222,height=207] image:media\image6.png[image,width=309,height=209]
...
image:media\image7.emf[image,width=605,height=723]

Figure 4: Package dependency of the Environmental Monitoring Facilities application schema

image:media\image8.emf[image,width=594,height=855]
...
image:media\image9.emf[image,width=651,height=503]
...
image:media\image10.emf[image,width=618,height=518]
...
image:media\image11.emf[image,width=623,height=756]
...
image:media\image12.emf[image,width=604,height=509]
...
image:media\image13.emf[image,width=604,height=350]
...
image:media\image14.emf[image,width=604,height=131]
...
image:media\image15.emf[image,width=603,height=466]
...
image:media\image16.emf[image,width=604,height=757]
...
          <se:Title>__Environmental Monitoring Facilities__ Default Style Representative Point</se:Title>
...
          <se:Title>__Environmental Monitoring Facilities__ Default Style Point</se:Title>
...
          <se:Title>__Environmental Monitoring Facilities__ Default Style Curve</se:Title>
...
          <se:Title>__Environmental Monitoring Facilities__ Default Style Surface</se:Title>
...
{empty}a) +++Purpose+++: Verify whether all the updates in the source dataset(s) have been transmitted to the dataset(s) which can be retrieved for the EF data theme using INSPIRE download services.
...
{empty}a) +++Purpose+++: Verify whether the metadata for interoperability of spatial data sets and services described in 1089/2010 Commission Regulation have been created and published for each dataset related to the EF data theme.
...
{empty}b) +++Reference+++: Art.6(3) and Annex IV Section 7.3
...
{empty}b) Reference: Art. 14(1), Art14(2) and Annex IV Section 7.4.
...
image:media\image17.emf[image,width=594,height=474]

=== 1a. Identify Facilities and Networks available for a given area of interest and domain

image:media\image18.emf[image,width=580,height=148]
...
image:media\image19.emf[image,width=624,height=138]
...
image:media\image20.emf[image,width=618,height=148]
...
a|
____
{empty}2. Providing information on what an EF is actually monitoring (observing capability)
____
...
image:media\image21.emf[image,width=619,height=188]
...
image:media\image22.emf[image,width=648,height=163]
...
image:media\image23.emf[image,width=636,height=151]
...
image:media\image24.emf[image,width=635,height=133]
...
|image:media\image25.jpeg[image,width=339,height=255]
a|
...
|image:media\image26.jpeg[image,width=261,height=261]
a|
...
|image:media\image26.jpeg[image,width=72,height=267]
a|
...
image:media\image27.emf[image,width=623,height=629]

* *ObservingCapability and Observation*

[cols=",",]
|===
|image:media\image28.emf[image,width=548,height=528] a|
For the ease of the example we have simplified the initial Sandre’s hydrometric data model.
...
____
image:media\image29.emf[image,width=604,height=448]
____
...
image:media\image30.png[image,width=425,height=307]
...
image:media\image31.emf[image,width=605,height=569]
...
image:media\image33.emf[image,width=754,height=473]

[cols=",",]
|===
|image:media\image34.emf[image,width=643,height=552] |In this diagram, the example above has been extended through the addition of an observation. This refers to the same Phenomenon, Process Used and Feature of Interest as the Observing Capability described above. In addition, it provides a result on the Range association, which contains the actual canopy cover of pine on the field inventory square.
|===
...
image:media\image35.emf[image,width=867,height=446]

[cols=",",]
|===
|image:media\image36.emf[image,width=608,height=524] |In this diagram, the example above has been extended through the addition of an observation. This refers to the same Phenomenon and Process Used as the Observing Capability described above, but provides a different Feature of Interest representing the actual location of the individual species being reported. In addition, it provides a result on the Range association, which identifies which species (_Juncus anceps)_ was identified.
|===
...
image:media\image37.emf[image,width=604,height=652]
...
image:media\image38.emf[image,width=605,height=694]
...
|image:media\image41.png[Station,width=158,height=263]
...
image:media\image43.emf[image,width=741,height=541]
...
image:media\image44.emf[image,width=604,height=725]
...
image:media\image45.emf[image,width=890,height=496]
...
image:media\image46.emf[image,width=604,height=618]
...
image:media\image48.emf[image,width=385,height=292]

Figure 19: © Rosette sampler

image:media\image49.emf[image,width=383,height=444]
...
image:media\image50.emf[image,width=488,height=510]
...
image:media\image51.emf[image,width=564,height=796]
...
____
image:media\image52.emf[image,width=641,height=483]
____

* *ObservingCapability and Observation for the automated sampling device*

____
image:media\image53.emf[image,width=602,height=532]
____
...
* Common Data types,
* {empty}(B) Information on zones and agglomerations,
* {empty}(C) Information on the assessment regime,
* {empty}(D) Information on the assessment methods:
** {empty}(i) General: information for all assessment methods,
** {empty}(ii) Fixed measurement Information,
** {empty}(iii) Indicative Measurement Information,
** {empty}(iv) Modelling Information,
** {empty}(v) Objective Estimation Information.
* {empty}(E) Information on primary validated assessment data and primary up-to-date assessment data,
* {empty}(F) Information on generated aggregated data,
* {empty}(G) Information on the attainment of environmental objectives,
* {empty}(H) Information on air quality plans,
* {empty}(I) Information on source apportionment,
* {empty}(J) Information on the scenario for the attainment year,
* {empty}(K) Information on measures.
