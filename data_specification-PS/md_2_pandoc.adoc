...
[cols=",",]
|===
|*Title* |D2.8.I.9 Data Specification on _Protected Sites_ – Technical Guidelines
|*Creator* |INSPIRE Thematic Working Group _Protected Sites_
|*Date* |2014-04-17
|*Subject* |INSPIRE Data Specification for the spatial data theme _Protected Sites_
|*Publisher* |European Commission Joint Research Centre
|*Type* |Text
|*Description* |This document describes the INSPIRE Data Specification for the spatial data theme _Protected Sites_
|*Contributor* |Members of the INSPIRE Thematic Working Group _Protected Sites_
...
5.1 Application schemas – Overview 8

5.1.1 Application schemas included in the IRs 8

5.1.2 Additional recommended application schemas 9
...
5.2.5 Identifier management 15

5.2.6 Geometry representation 15

5.2.7 Temporality representation 15

5.3 Application schema Protected Sites Simple 16

5.3.1 Description 16

5.3.2 Feature catalogue 20

6 Reference systems, units of measure and grids 25

6.1 Default reference systems, units of measure and grid 25

6.1.1 Coordinate reference systems 26

6.1.2 Temporal reference system 28

6.1.3 Units of measure 29

7 Data quality 29

7.1 Data quality elements 30

7.1.1 Completeness – Commission 30

7.1.2 Completeness – Omission 31

7.1.3 Logical consistency – Conceptual consistency 31

7.1.4 Logical consistency – Domain consistency 32

7.1.5 Positional accuracy – Absolute or external accuracy 32

7.2 Minimum data quality requirements 33

7.3 Recommendation on data quality 33

8 Dataset-level metadata 33

8.1 Metadata elements defined in INSPIRE Metadata Regulation 33

8.1.1 Conformity 35

8.1.2 Lineage 37

8.1.3 Temporal reference 37

8.2 Metadata elements for interoperability 38

8.2.1 Coordinate Reference System 39

8.2.2 Temporal Reference System 39

8.2.3 Encoding 40

8.2.4 Character Encoding 41

8.2.5 Spatial representation type 41

8.2.6 Data Quality – Logical Consistency – Topological Consistency 42

8.3 Recommended theme-specific metadata elements 42

8.3.1 Maintenance Information 42

8.3.2 Metadata elements for reporting data quality 43

9 Delivery 45

9.1 Updates 45

9.2 Delivery medium 45

9.3 Delivery content 46

9.4 Data sensitivity 46

9.5 Encodings 46

9.5.1 Default Encoding(s) 47

10 Data Capture 48

11 Portrayal 48

11.1 Layers to be provided by INSPIRE view services 49

11.1.1 Layers organisation 51

11.2 Styles required to be supported by INSPIRE view services 52

11.2.1 Styles for the layer PS.ProtectedSite 52

Bibliography 53

Annex A (normative) Abstract Test Suite 55

A.1 Application Schema Conformance Class 58

A.1.1 Schema element denomination test 58

A.1.2 Value type test 58

A.1.3 Value test 58

A.1.4 Attributes/associations completeness test 59

A.1.5 Abstract spatial object test 59

A.1.6 Constraints test 59

A.1.7 Geometry representation test 60

A.2 Reference Systems Conformance Class 60

A.2.1 Datum test 60

A.2.2 Coordinate reference system test 60

A.2.3 View service coordinate reference system test 61

A.2.4 Temporal reference system test 61

A.2.5 Units of measurements test 61

A.3 Data Consistency Conformance Class 62

A.3.1 Unique identifier persistency test 62

A.3.2 Version consistency test 62

A.3.3 Update frequency test 62

A.4 Metadata IR Conformance Class 63

A.4.1 Metadata for interoperability test 63

A.5 Information Accessibility Conformance Class 63

A.5.1 Code list publication test 63

A.5.2 CRS publication test 63

A.5.3 CRS identification test 64

A.6 Data Delivery Conformance Class 64

A.6.1 Encoding compliance test 64

A.7 Portrayal Conformance Class 64

A.7.1 Layer designation test 64

A.8 Technical Guideline Conformance Class 65

A.8.1 Multiplicity test 65

A.8.2 CRS http URI test 65

A.8.3 Metadata encoding schema validation test 65

A.8.4 Metadata occurrence test 65

A.8.5 Metadata consistency test 66

A.8.6 Encoding schema validation test 66

A.8.7 Style test 66

Annex B (informative) Use cases 67

B.1 Generate European Protected Sites Spatial Data Report 69

B.2 Naively Query and View Protected Sites 70

B.3 Expertly Query, View, Visualise and Analyse Protected Sites 71

B.4 Download Protected Sites Data 72

B.5 Provide Protected Sites Data Using INSPIRE Specifications 74

Annex C (normative) Code list values 82

C.1 INSPIRE Application Schema 'Protected Sites Simple' 82
...
image:media\image5.emf[image,width=604,height=651] Figure 1 – UML Diagram: Simple application schema
...
|Description a|
The true value of an observable image:media\image6.wmf[image,width=16,height=17] is known as image:media\image7.wmf[image,width=16,height=24]. From this, the estimator

image:media\image8.wmf[image,width=151,height=51]

yields to the linear root mean square error RMSE = image:media\image9.wmf[image,width=20,height=23].
...
A.1 Application Schema Conformance Class 59

A.1.1 Schema element denomination test 59

A.1.2 Value type test 59

A.1.3 Value test 59

A.1.4 Attributes/associations completeness test 60

A.1.5 Abstract spatial object test 60

A.1.6 Constraints test 60

A.1.7 Geometry representation test 61

A.2 Reference Systems Conformance Class 61

A.2.1 Datum test 61

A.2.2 Coordinate reference system test 61

A.2.3 View service coordinate reference system test 62

A.2.4 Temporal reference system test 62

A.2.5 Units of measurements test 62

A.3 Data Consistency Conformance Class 63

A.3.1 Unique identifier persistency test 63

A.3.2 Version consistency test 63

A.3.3 Update frequency test 63

A.4 Metadata IR Conformance Class 64

A.4.1 Metadata for interoperability test 64

A.5 Information Accessibility Conformance Class 64

A.5.1 Code list publication test 64

A.5.2 CRS publication test 64

A.5.3 CRS identification test 65

A.6 Data Delivery Conformance Class 65

A.6.1 Encoding compliance test 65

A.7 Portrayal Conformance Class 65

A.7.1 Layer designation test 65

A.8 Technical Guideline Conformance Class 66

A.8.1 Multiplicity test 66

A.8.2 CRS http URI test 66

A.8.3 Metadata encoding schema validation test 66

A.8.4 Metadata occurrence test 66

A.8.5 Metadata consistency test 67

A.8.6 Encoding schema validation test 67
...
{empty}a) +++Purpose+++: Verify whether all the updates in the source dataset(s) have been transmitted to the dataset(s) which can be retrieved for the PS data theme using INSPIRE download services.
...
{empty}a) +++Purpose+++: Verify whether the metadata for interoperability of spatial data sets and services described in 1089/2010 Commission Regulation have been created and published for each dataset related to the PS data theme.
...
{empty}b) +++Reference+++: Art.6(3) and Annex II Section 9.4
...
{empty}b) Reference: Art. 14(1), Art14(2) and Annex II Section 9.5.
...
image:media\image10.emf[image,width=604,height=502]
...
{empty}2. Updated site boundaries on the cumulative data layer are not easily detectable from using the digital cumulative data layer or the N2K database as there is no version attribute to denote change. This can lead to confusion in use of the data layer by wider users.

{empty}3. Cross border sites are dealt with through an agreed protocol between the countries; one country takes the lead in defining and providing JNCC with relevant site boundary. This is done in cooperation with the adjoining country to ensure that the site boundaries are defined consistently across the country border.

{empty}4. Cross member state boundaries (UK and Eire) are resolved by defining two sites on each side of the international border.

{empty}5. Issues arise when the cumulative data layer is used in other GIS systems when geometric standards differ between systems an example include unclosed polygons. This is one reason why the JNCC provide access to two versions of the same data; one is the European standard cumulative data layer, the other is the UK dynamic data layer. The latter is the preferred download by UK users as it integrates better with their current use of base reference mapping.
