...
|*Date* |2014-04-17
|*Subject* |INSPIRE Data Specification for the spatial data theme _Administrative Units_
|*Publisher* |European Commission Joint Research Centre
|*Type* |Text
|*Description* |This document describes the INSPIRE Data Specification for the spatial data theme _Administrative Units_
...
2.3 Normative References 13

2.4 Terms and definitions 14

2.5 Symbols and abbreviations 14

2.6 How the Technical Guidelines map to the Implementing Rules 15

2.6.1 Requirements 15

2.6.2 Recommendations 16

2.6.3 Conformance 16

3 Specification scopes 16

4 Identification information 17

5 Data content and structure 17

5.1 Application schemas – Overview 17

5.1.1 Application schemas included in the IRs 17

5.2 Basic notions 18

5.2.1 Notation 18

5.2.2 Voidable characteristics 20

5.2.3 Enumerations 21

5.2.4 Code lists 21

5.2.5 Consistency between spatial data sets 24

5.2.6 Identifier management 24

5.2.7 Geometry representation 25

5.2.8 Temporality representation 25

5.3 Administrative Units – Application schemas 26

5.3.1 Description 26

5.4 Application schema AdministrativeUnits 28

5.4.1 Description 28

5.4.2 Feature catalogue 39

5.5 Application schema MaritimeUnits 47

5.5.1 Description 47

5.5.2 Feature catalogue 52

6 Reference systems, units of measure and grids 58

6.1 Default reference systems, units of measure and grid 58

6.1.1 Coordinate reference systems 58

6.1.2 Temporal reference system 61

6.1.3 Units of measure 62

7 Data quality 62

7.1 Data quality elements 62

7.1.1 Completeness – Commission 63

7.1.2 Completeness – Omission 63

7.1.3 Logical consistency – Conceptual consistency 64

7.1.4 Logical consistency – Domain consistency 64

7.1.5 Logical Consistency – Topological consistency 65

7.1.6 Positional accuracy – Absolute or external accuracy 66

7.2 Minimum data quality requirements 67

7.3 Recommendation on data quality 67

8 Dataset-level metadata 67

8.1 Metadata elements defined in INSPIRE Metadata Regulation 67

8.1.1 Conformity 68

8.1.2 Lineage 70

8.1.3 Temporal reference 71

8.2 Metadata elements for interoperability 71

8.2.1 Coordinate Reference System 72

8.2.2 Temporal Reference System 73

8.2.3 Encoding 74

8.2.4 Character Encoding 74

8.2.5 Spatial representation type 75

8.2.6 Data Quality – Logical Consistency – Topological Consistency 75

8.3 Recommended theme-specific metadata elements 75

8.3.1 Maintenance Information 76

8.3.2 Metadata elements for reporting data quality 76

9 Delivery 78

9.1 Updates 78

9.2 Delivery medium 79

9.3 Encodings 80

9.3.1 Default Encoding(s) 80

10 Data Capture 82

11 Portrayal 83

11.1 Layers to be provided by INSPIRE view services 84

11.1.1 Layers organisation 85

11.2 Styles required to be supported by INSPIRE view services 85

11.2.1 Styles for the layer AU.AdministrativeUnit 85

11.2.2 Styles for the layer AU.AdministrativeBoundary 86

11.2.3 Styles for the layer AU.Condominium 86

11.2.4 Styles for the layer AU.Baseline 87

11.2.5 Styles for the layer AU.MaritimeBoundary 88

11.2.6 Styles for the layer AU.ContiguousZone 89

11.2.7 Styles for the layer AU.ContinentalShelf 90

11.2.8 Styles for the layer AU.ExclusiveEconomicZone 91

11.2.9 Styles for the layer AU.InternalWaters 92

11.2.10 Styles for the layer AU.TerritorialSea 93

11.3 Styles recommended to be supported by INSPIRE view services 94

Bibliography 95

Annex A (normative) Abstract Test Suite 97

A.1 Application Schema Conformance Class 100

A.1.1 Schema element denomination test 100

A.1.2 Value type test 100

A.1.3 Value test 100

A.1.4 Attributes/associations completeness test 101

A.1.5 Constraints test 101

A.1.6 Geometry representation test 102

A.2 Reference Systems Conformance Class 102

A.2.1 Datum test 102

A.2.2 Coordinate reference system test 102

A.2.3 View service coordinate reference system test 103

A.2.4 Temporal reference system test 103

A.2.5 Units of measurements test 103

A.3 Data Consistency Conformance Class 104

A.3.1 Unique identifier persistency test 104

A.3.2 Version consistency test 104

A.3.3 Life cycle time sequence test 104

A.3.4 Update frequency test 105

A.3.5 Administrative unit higher hierarchy test 105

A.3.6 Administrative unit lower hierarchy test 105

A.3.7 Co-administered Administrative unit test 105

A.3.8 Administrative unit area test 106

A.3.9 Administrative boundary test 106

A.3.10 Condominium spatial extent test 106

A.3.11 Condominium administration test 106

A.4 Metadata IR Conformance Class 106

A.4.1 Metadata for interoperability test 107

A.5 Information Accessibility Conformance Class 107

A.5.1 CRS publication test 107

A.5.2 CRS identification test 107

A.6 Data Delivery Conformance Class 107

A.6.1 Encoding compliance test 107

A.7 Portrayal Conformance Class 108

A.7.1 Layer designation test 108

A.8 Technical Guideline Conformance Class 109

A.8.1 Multiplicity test 109

A.8.2 CRS http URI test 109

A.8.3 Metadata encoding schema validation test 109

A.8.4 Metadata occurrence test 109

A.8.5 Metadata consistency test 110

A.8.6 Encoding schema validation test 110

A.8.7 Style test 110

Annex B (informative) Use cases 111

B.1 Filtering data 111

B.2 Discovery of unit related data 112

B.3 Linking thematic information 112

B.4 Disaster and environmental management 113

B.5 Boundary based analysis 113

Annex C (normative) Code list values 114

C.1 INSPIRE Application Schema 'AdministrativeUnits' 114

C.2 INSPIRE Application Schema 'MaritimeUnits' 115

Annex D (informative) National Administrative Hierarchies (examples) 117

D.1 Example from Germany 117

D.2 Example from Norway 118

Annex E (informative) Limitations in the use of Administrative Units data 120
...
image:media\image5.emf[image,width=458,height=453]
...
image:media\image7.emf[image,width=605,height=415]
...
{empty}(2) Each instance of spatial object type AdministrativeUnit, except for those at the lowest level, shall refer to their respective lower level units. This correspondence shall be expressed by the lowerLevelUnit association role of AdministrativeUnit spatial object type.
...
{empty}(3) If an administrative unit is co-administered by two or more other administrative units the association role administeredBy shall be used. The units co-administering this unit shall apply inverse role coAdminister.
...
{empty}(4) Administrative units at the same level of administrative hierarchy shall not conceptually share common areas.
...
image:media\image8.emf[image,width=642,height=277]
...
{empty}(5) Instances of the spatial object type AdministrativeBoundary shall correspond to the edges in the topological structure of the complete (including all levels) boundary graph.
...
{empty}(6) The spatial extent of a condominium may not be part of the geometry representing the spatial extent of an administrative unit.
...
{empty}(7) Condominiums can only be administered by administrative units at country level.
...
image:media\image10.png[image,width=460,height=321]
...
{empty}a) +++Purpose+++: Verify whether all the updates in the source dataset(s) have been transmitted to the dataset(s) which can be retrieved for the Administrative Units data theme using INSPIRE download services.
...
{empty}a) +++Purpose+++: Verify whether each instance of administrative unit, except those corresponding to the country level unit representing a Member State and co-administered units, refers exactly to one unit at a higher level of administrative hierarchy by using the upperLevelUnit association role.

{empty}b) +++Reference+++: Annex II Section 4.4(1) and (2) of Commission Regulation 1089/2010.

{empty}c) +++Test Method+++: For each administrative unit neither corresponding to the country level unit representing a Member State nor being a co-administered unit, inspect that:
...
{empty}a) +++Purpose+++: Verify whether each instance of administrative unit, except those corresponding to the lowest level, refers to its respective lower level units in the administrative hierarchy by using the lowerLevelUnit association role.

{empty}b) +++Reference+++: Annex II Section 4.4(1) and (2) of Commission Regulation 1089/2010.

{empty}c) +++Test Method+++: For each administrative unit not corresponding to the lowest level of the administrative hierarchy, inspect that:
...
{empty}a) +++Purpose+++: Verify whether the association role administeredBy is used for each administrative unit which is co-administered by two or more administrative units; verify whether the inverse association role coAdminister is used for these administrative units which co-administer that unit.

{empty}b) +++Reference+++: Annex II Section 4.4(3) of Commission Regulation 1089/2010.

{empty}c) +++Test Method+++: For each administrative unit co-administered by two or more other administrative units, inspect that:
...
{empty}a) +++Purpose+++: Verify whether administrative units having the same level of administrative hierarchy do not conceptually share common areas.

{empty}b) +++Reference+++: Annex II Section 4.4(4) of Commission Regulation 1089/2010.

{empty}c) +++Test Method+++: Inspect that the geometry of each administrative unit does not overlap with the geometries of other administrative units having the same level of administrative hierarchy as the examined one.

==== Administrative boundary test

{empty}a) +++Purpose+++: Verify whether all instances of the spatial object type administrative boundary correspond to the edges in the topological structure of the complete (including all levels) boundary graph.

{empty}b) +++Reference+++: Annex II Section 4.4(5) of Commission Regulation 1089/2010.

{empty}c) +++Test Method+++: Inspect that the geometry of each instance administrative boundary correspond to an edge in the topological structure formed by the complete boundary graph, including the boundaries of all levels.

==== Condominium spatial extent test

{empty}a) +++Purpose+++: Verify whether the spatial extent of a condominium is not part of the geometry representing the spatial extent of an administrative unit.

{empty}b) +++Reference+++: Annex II Section 4.4(6) of Commission Regulation 1089/2010.

{empty}c) +++Test Method+++: Inspect each condominium and verify that its geometry does not overlap with the geometry of any of the administrative units in the same data set.

==== Condominium administration test

{empty}a) +++Purpose+++: Verify whether each condominium is only administered by administrative units at country level.

{empty}b) +++Reference+++: Annex II Section 4.4(7) of Commission Regulation 1089/2010.

{empty}c) +++Test Method+++: Inspect that each condominium only refers to administrative units at country level (each of them representing a Member State) through using the admUnit association role of the condominium spatial object type.
...
{empty}a) +++Purpose+++: Verify whether the metadata for interoperability of spatial data sets and services described in 1089/2010 Commission Regulation have been created and published for each dataset related to the Administrative Units data theme.
...
{empty}b) Reference: Art. 14(1), Art14(2) and Annex II Section 4.5 .
...
{empty}b) +++Test Method+++: Inspect whether provided encoding(s) is (are) conformant to the encoding(s) for the relevant application schema(s) as defined in section 9:
...
image:media\image17.png[image,width=608,height=379]
...
image:media\image18.wmf[image,width=585,height=180]
