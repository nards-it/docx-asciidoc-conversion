...
2.4 Terms and definitions 2

2.5 Symbols and abbreviations 3

2.6 How the Technical Guidelines map to the Implementing Rules 4

2.6.1 Requirements 4

2.6.2 Recommendations 5
...
5 Geographical Grid Systems 6

5.1 Overview 6

5.2 Geographic grids for INSPIRE 7

5.2.1 Equal Area Grid 8

5.2.2 Zoned Geographic Grid 9

5.3 Modelling of grids 14

5.4 Manipulation with grid values 15

Bibliography 16

Annex A (normative) Abstract Test Suite 18

A.1 Equal Area Grid test 18

A.2 Zoned Geographic Grid test 19
...
{empty}(1) When gridded data is delivered using geodetic coordinates the multi-resolution grid defined in this Section may be used as a geo-referencing framework.
...
{empty}[EUR 20120 EN] Map Projections for Europe – EUR Report 20120 EN. Proceedings of the “Map Projections for Europe” workshop, Marne-La Vallee, 14-15 December 2000 footnote:[http://www.ec-gis.org/sdi/publist/pdfs/annoni-etal2003eur.pdf]

{empty}[EUR 21494 EN] European Reference Grids – EUR Report 21494 EN. Proceedings of the “European Reference Grids” workshop, Ispra, 27-29 October 2003 footnote:[http://www.ec-gis.org/sdi/publist/pdfs/annoni2005eurgrids.pdf]
...
{empty}c) +++Test Method+++: Check whether the dataset is based on one of the following grids:
____
...
{empty}a) +++Purpose+++: Verify that if a geographical grid based on the ETRS89-LAEA coordinate reference system is used for the provision of gridded data within the geographical scope of ETRS89, such grid corresponds to the Equal Area Grid (Grid_ETRS89-LAEA) as defined in Commission Regulation No 1089/2010.

{empty}b) +++Reference+++: Annex II Section 2.2 and 2.2.1 of Commission Regulation 1089/2010.

{empty}c) +++Test Method+++: Check whether the ETRS89-LAEA geographic grid complies with the characteristics specified for the Equal Area Grid (Grid_ETRS89-LAEA):
...
{empty}a) +++Purpose+++: Verify that if a geographical grid based on the ETRS89-GRS80 coordinate reference system is used for the provision of gridded data within the geographical scope of ETRS89, such grid corresponds to the Zoned Geographic Grid (Grid_ETRS89-GRS80z__n__) as defined in Commission Regulation No 1089/2010.

{empty}b) +++Reference+++: Annex II Section 2.2 and 2.2.2 of Commission Regulation 1089/2010.

{empty}c) +++Test Method+++: Check whether the ETRS89-GRS80 geographic grid complies with the characteristics specified for the Zoned Geographic Grid (Grid_ETRS89-GRS80z__n__):
