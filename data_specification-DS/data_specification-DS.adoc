...
latexmath:[\frac{y}{t_{\text{last}} - x - d}] and shall be greater than *0.5 MB/s or*

latexmath:[$\frac{z}{t_{\text{last}} - x - d}] and shall be greater than *500 spatial objects / descriptions per second.*
