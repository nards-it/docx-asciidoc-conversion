...
* image::./media/image12.png[image, align=left]
...
image::.media/image13.png[image, align=left] and shall be greater than *0.5 MB/s or*

image::./media/image14.png[image, align=left] and shall be greater than *500 spatial objects / descriptions per second.*
