...
* y/(t~last~ -x -d) ≥ 0.5 [MB/s] or z/(t~last~ -x -d) ≥ 500 [(objects|descriptions)/s]
...
y/t~last~ -x -d and shall be greater than *0.5 MB/s* or

z/t~last~ -x -d and shall be greater than *500 spatial objects / descriptions per second.*
