...
image::./media/image16.png[Intermodal,width=604,height=388]
...
|Description a|
For a number of points (_N_), the measured positions are given as image::./media/image53.png[image,width=23,height=24], image::./media/image54.png[image,width=24,height=24] and image::./media/image55.png[image,width=23,height=24] coordinates depending on the dimension in which the position of the point is measured. A corresponding set of coordinates, image::./media/image56.png[image,width=19,height=24], image::./media/image57.png[image,width=20,height=24] and image::./media/image58.png[image,width=19,height=24]
, are considered to represent the true positions. The errors are calculated as 1D: image::./media/image59.png[image,width=87,height=27, align=center]
2D: image::./media/image60.png[image,width=193,height=32, align=center]
3D: image::./media/image61.png[image,width=273,height=32, align=center]
...
{empty}2. Temporal Reference System: ion of the temporal reference system(s) used in the data set.
+
