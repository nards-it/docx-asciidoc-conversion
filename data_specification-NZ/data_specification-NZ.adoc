...
image::./media/image14.png[image,width=600,height=695, align=center]
...
image::./media/image15.png[image,width=331,height=348]
image::./media/image16.png[image,width=176,height=35, align=center]
...
image::./media/image17.png[image,width=604,height=476, align=center]
...
image::./media/image18.png[image,width=604,height=320, align=center]
...
image::./media/image19.png[image,width=498,height=352, align=center]
...
image::./media/image22.jpeg[DiagramaUML MSvisio Raquel_jb,width=330,height=303]
...
!===
!Name: !social
!Definition: !Anything related to people or groups of people.
!===
...
!===
!Name: !people
!Definition: !The presence of human beings.
!Parent: !social
!===
...
!===
!Name: !community
!Definition: !A complex relation between human beings acting as a whole or as a unit.
!Parent: !social
!===
...
!===
!Name: !political
!Definition: !Any object relevant to political affairs.
!Parent: !social
!===
...
!===
!Name: !social service
!Definition: !Any service provided to people.
!Parent: !social
!===
...
!===
!Name: !economic
!Definition: !Any object related to property, economics or monetary issues.
!===
...
!===
!Name: !property
!Definition: !Any object subject to ownership, such as a house.
!Parent: !economic
!===
...
!===
!Name: !infrastructure
!Definition: !Any object considered as a structure providing a service, such as a road, a bridge, a military facility, etc.
!Parent: !economic
!===
...
!Definition: !Any object representing an economic activity, such as an industry.
!Parent: !economic
!===
...
!===
!Name: !rural land use
!Definition: !Any non-urban object that is dedicated to any given use.
!Parent: !economic
!===
...
!===
!Name: !environmental
!Definition: !An area subject to a given protection level, such as a natural park.
!===
...
!===
!Name: !water body
!Definition: !Any significant accumulation of water.
...
!===
!Name: !protected area
!Definition: !An area that is protected
!Parent: !environmental
!===
...
!Definition: !An object that contains pollutants.
!Parent: !environmental
!===
...
!===
!Name: !heritage
!Definition: !Anything related to relevant objects from a cultural or heritage perspective.
!===
...
!===
!Name: !cultural asset
!Definition: !Any object considered to be relevant from a cultural perspective, such as a stadium, a theatre, a museum, etc.
!Parent: !heritage
!===
...
!Definition: !Any object with a historical relevance.
!Parent: !heritage
!===
...
!Definition: !A place (such as a forest, mountain, lake, desert, monument, building, complex, or city) that is listed by the UNESCO as of special cultural or physical significance.
!Parent: !heritage
!===
...
!===
!Name: !tsunami
!Definition: !Long wave disruption in a large water body reaching emerged land.
!Description: !"Tsunamis can be triggered by earthquakes, landslide, volcanic explosions, meteorites, etc. Even though it is a certain type of flood it is usually considered as a separated process."
!Parent: !geologicalHydrological
!===
...
!===
!Name: !volcanic
!Definition: !An opening, or rupture, in the Earth's crust that allows hot magma, ash and gases to escape.
!Description: !"Process directly linked to volcanic eruptions are expected to be included in this category, such as lahars, j÷kulhaups, ash fall, volcanic explosions, freatic explosions, etc."
!Parent: !geologicalHydrological
!===
...
!===
!Name: !earthquake
!Definition: !Earthquake hazards involve the propagation of elastic waves at or near the surface after the release of tectonic stress or other natural sources, such as volcanic explosions or meteorite impacts.
!Description: !"Liquefaction, ground shaking and other effects directly caused by seismic waves should also be included in this category. Processes that might be triggered by other processes might fit best in other classes."
!Parent: !geologicalHydrological
!===
...
!Description: !"Subsidence and collapse can be associated with carbonate rocks in karstic areas, but it can occur in other regions such as loessic soils or compressible soils."
!Parent: !geologicalHydrological
!===
...
!===
!Name: !landslide
!Definition: !Processes of downhill slope movements of soil, rock, and organic materials related to different types of ground failure.
!Description: !"Some common terms used for describing different types of landslides include but are not restricted to slides, rock fall, debris flow."
!Parent: !geologicalHydrological
!===
...
!===
!Name: !snow avalanche
!Definition: !A snow mass with typically a volume greater than 100 m3 and a minimum length of 50 meters that slides rapidly downhill.
!Description: !"Snow avalanches usually incorporate materials swept along the path of the snow avalanche, such as trees, rocks, etc. Avalanche formation is the result of a complex interaction between terrain, snow pack and meteorological conditions"
!Parent: !geologicalHydrological
!===
...
!===
!Name: !flood
!Definition: !Processes of inundation of usually dry (emerged) land, or temporary covering by water of land not normally covered by water.
!Description: !"Floods can be of many types (flash floods, river overflow, tidal floods), and can have many triggers (precipitation, natural water reservoir dam failure, river channel obstruction, etc). Tsunamis and a storm surges are usually considered as a different natural hazard."
!Parent: !geologicalHydrological
!===
...
[cols=","]
!===
!Name: !toxic or radioactive
!Definition: !Processes related to the nature of substances that might pose a threat to human health.
!Description: !"Asbestos, natural radioactivity or gas emanation are some examples of hazards within this category"
!Parent: !geologicalHydrological
!===
...
[cols=","]
!===
!Name: !meteorological / climatological
!Definition: !Processes that have a meteorological (atmospheric) or climatic (changes in the long-run of environmental variables) nature (or origin).
!===
...
!Definition: !An abnormal temperature rise or decrease lasting longer than usual temperature rise or drop.
!Description: !Heat waves or cold waves.
!Parent: !meteorologicalClimatological
!===
...
[cols=","]
!===
!Name: !"tornados, hurricanes and strong winds"
!Definition: !Violent (high speed) winds.
!Parent: !meteorologicalClimatological
!===
...
!===
!Name: !lightning
!Definition: !Discharge of atmospheric electricity.
!Parent: !meteorologicalClimatological
!===
...
!===
!Name: !storm surge
!Definition: !Water pushed from the sea onto the land caused by an atmospheric disruption such as a hurricane or a rapid change in atmospheric pressure.
!Description: !"Although a storm surge is a kind of flood, it is usually considered as a separated class."
!Parent: !meteorologicalClimatological
!===
...
!===
!Name: !fires
!Definition: !This category includes all types of processes that involve the occurrence and spreading of fire.
!===
...
!Definition: !Fire spreading below the surface, typically occurring in peat rich soils.
!Parent: !fires
!===
...
!===
!Name: !biological
!Definition: !Processes that are directly linked to living organisms or products produced by living organisms.
!===
...
!===
!Name: !infestation
!Definition: !Abnormal population increase of living organisms.
!Parent: !biological
!===
...
!===
!Name: !epidemic
!Definition: !An outbreak of a disease that spreads rapidly among individuals in an area or population.
!===
...
!===
!Name: !allergens
!Definition: !Biological products or substances (such as pollen) that might cause allergy over a large number of people.
!Parent: !biological
!===
...
!===
!Name: !cosmic
!Definition: !Processes from outer space.
!===
...
!Definition: !Solid materials from outer space reaching the Earth.
!Parent: !cosmic
!===
...
!Definition: !Disturbances of the magnetic field of the Earth.
!Parent: !cosmic
!===
...
[cols=","]
!===
!Name: !solar and cosmic radiations
!Definition: !Radiation from outer space (UV, gamma ray, etc).
!Parent: !cosmic
!===
...
|===
a|
*otherGeologicalHydrological*

[cols=","]
!===
!Name: !other geological / hydrological hazard
!Definition: !Any process not already addressed within other geological or hydrological categories
!Description: !"Sand dune movements, soil erosion, maelstroms, iceberg movements among other processes can be included here."
!===

a|
*otherMeteorologicalClimatological*

[cols=","]
!===
!Name: !other meteorological / climatological hazard
!Definition: !Any process not already addressed within other meteorological / Climatological categories
!Description: !Natural desertification can be included in this category.
!===
...
!===
!Name: !other fires
!Definition: !Other natural fires not already addressed within other fire categories
!Description: !Spontaneous combustion can be included in this category
!===
...
[cols=","]
!===
!Name: !other biological hazards
!Definition: !Other biological hazards not already addressed within other biological categories
!Description: !Prions and other toxic substances produced by (or within) living organisms can be included here.
!===
...
[cols=","]
!===
!Name: !other cosmic hazard
!Definition: !Other cosmic hazards not already addressed within other cosmic categories
!===
